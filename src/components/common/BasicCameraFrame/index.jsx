...
export const BasicCameraFrame1 = ({ bgsrc, isCapturing, currentFrame }) => {
  ...
  return (
    <div
      className={`flex h-[470px] w-[180px] flex-col gap-[5px] border-2 px-[19px] py-[21px] shadow-lg ${
...
export const BasicCameraFrame2 = ({ bgsrc, isCapturing, currentFrame }) => {
  ...
  return (
    <div
      className={`w-real-screen flex h-[470px] flex-col gap-[4px] border-2 px-[10px] py-[26px] shadow-lg ${
        isColor ? `bg-BGColor-${bgsrc}` : ""
      }`}
      style={{
        backgroundImage: isImage ? `url(${bgsrc})` : "none",
...
export const BasicCameraFrame3 = ({ bgsrc, isCapturing, currentFrame }) => {
  ...
  return (
    <div
      className={`w-real-screen flex h-[280px] flex-col gap-[5px] border-2 px-[23px] py-[17px] shadow-lg ${
        isColor ? `bg-BGColor-${bgsrc}` : ""
      }`}
      style={{
        backgroundImage: isImage ? `url(${bgsrc})` : "none",
...
export const BasicCameraFrame4 = ({ bgsrc, isCapturing, currentFrame }) => {
  ...
  return (
    <div
      className={`w-real-screen flex h-[280px] flex-col gap-[10px] border-2 px-[23px] py-[17px] shadow-lg ${
        isColor ? `bg-BGColor-${bgsrc}` : ""
      }`}
      style={{
        backgroundImage: isImage ? `url(${bgsrc})` : "none",
